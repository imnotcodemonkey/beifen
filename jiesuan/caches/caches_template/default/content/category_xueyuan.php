...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>学院介绍-中国人民大学课程研修班招生信息网</title>
	...
	<body style="overflow-x:hidden">
		...
		<div class="Brochures-wrap">
			<div class="Brochures">
				<div class="left">
					<div class="bm">
							<div class="title-bm"> <span>学院介绍</span> 
						</div>
						...
						<div class="xyjianjie">
							<div class="title-xy">
								<p class="xy"><span><?php echo $val['catname'];?></span></p>
								<a href="<?php echo $val['url'];?>">进入<?php echo $val['catname'];?>>></a>
							</div>
							<p class="ma-xy"><?php echo $val['description'];?></p>
