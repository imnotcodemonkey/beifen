...
if(window.location.href.indexOf("ruc.zaizhiyan")==7){
   	document.write('<link href="/_res/_g2015_SXY.css" rel="stylesheet" type="text/css" />');
}
...
function pageCount(){
	...
	src='/plus/counter.php?';
	aid=arguments[0];
	mid=arguments[1];
	if(arguments.length>2){src+="&click="+arguments[2];}
	src+= "&aid="+ aid; 
	src+= "&mid="+ mid ;
	src+= "&u="+ u ;
	src+= "&r="+ r ;
	src+= "&t="+ t  ;
	src+= "&hour=" + new Date().getHours();
...
function cnzz(){
	document.write('<scri'+'pt src="http://s85.cnzz.com/stat.php?id=4321030&web_id=4321030" type="text/javascript"></scr'+'ipt>');
}

function tqFloat(){
document.write('<scri'+'pt src="http://float2006.tq.cn/floatcard?adminid=8377824&sort=5" type="text/javascript"></scr'+'ipt>');
}
