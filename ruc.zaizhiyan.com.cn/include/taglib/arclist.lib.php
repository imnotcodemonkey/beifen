    ...
    if($idlist=='')
    {
        ...
        if($writer!=''){
        	if($writer=='this') {
        		...
        		$orwheres[] = " arc.mid = '$writer' ";//调取指定作者文档 2012年3月17日 16:26:22
        	}
        }
        ...
        if(!empty($typeid) && $typeid != 'top')
        {
            ...
            else
            {
                ...
                //else $orwheres[] = ' arc.typeid IN ('.GetSonIds($typeid).','.$CrossID.')'; //首页显示副栏目内容的方法--修改版 解决了flag标志的bug 2012年3月17日 17:42:42 leihaobin
