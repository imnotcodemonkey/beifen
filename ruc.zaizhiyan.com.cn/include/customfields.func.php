...
function GetFormItem($ctag, $admintype='admin')
{
    ...
    else if($fieldType=='radio')
    {
        ...
        foreach($items as $v)
        {
            ...
            if($v!='')
            {
                ...
                $myformItem .= "<label for='$fieldname-$i'><input type='radio' name='$fieldname' class='np' id='$fieldname-$i' value='$v'>$v</label>\r\n";
                $i++;
            }
        }
        $innertext = $myformItem;
    ...
    else if($fieldType=='checkbox')
    {
        ...
        {	$i++;
          ...
          $myformItem .= "<label for='$fieldname-$i'><input type='checkbox' name='{$fieldname}[]' id='$fieldname-$i' class='np' value='$v'>$v</label>\r\n";
                }
    ...
    {
        $innertext = "<textarea name='$fieldname' id='$fieldname' style='width:388px;height:80px'></textarea>\r\n";
    }
...
function GetFormItemValue($ctag, $fvalue, $admintype='admin', $fieldname='')
{
    ...
    {
        $innertext = "<textarea name='$fieldname' id='$fieldname' style='width:388px;height:80px'>$fvalue</textarea>\r\n";
    }
