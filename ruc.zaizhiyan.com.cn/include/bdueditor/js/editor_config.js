...
(function () {
    ...
    var tmp = window.location.pathname,
            URL = 'http://www.xschu.com/include/bdueditor/';//window.UEDITOR_HOME_URL||tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("_examples/","").replace("website/","");//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    UEDITOR_CONFIG = {
        imagePath:'http://www.xschu.com/', //URL + "../../xscfiles/ueimg/", //图片文件夹所在的路径，用于显示时修正后台返回的图片url！具体图片保存路径需要在后台设置。！important
        ...
        filePath:'http://www.xschu.com/', //URL + "../../xscfiles/ueimg/",  //附件文件夹保存路径
        ...
        snapscreenHost: 'www.xschu.com', //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
        snapscreenServerFile: "include/bdeditor/server/upload/php/snapImgUp.php", //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/php/snapImgUp.php"”
