...
function ShowMsg($msg,$gourl,$onlymsg=0,$limittime=0)
{
	...
	else
	{
      ...
      function JumpUrl(){
		...
		$rmsg .= "<div style='padding:6px;font-size:12px;border-bottom:1px solid #D1DDAA;background:#DBEEBD url({$GLOBALS['cfg_phpurl']}/img/wbg.gif)';'>人大在职研究生网-信息提示</div>\");\r\n";
...
{
	$dd=str_replace('0','f',$ddnum);
	$dd=str_replace('1','z',$dd);
	$dd=str_replace('2','2',$dd);
	$dd=str_replace('3','l',$dd);
	$dd=str_replace('4','h',$dd);
	$dd=str_replace('5','b',$dd);
	$dd=str_replace('6','y',$dd);
	$dd=str_replace('7','k',$dd);
	$dd=str_replace('8','n',$dd);
	$dd=str_replace('9','m',$dd);
	return $dd;
}
