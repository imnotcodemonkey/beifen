...
if(empty($uploadmbtype)) $uploadmbtype = '附件类型';
if(empty($bkurl)) $bkurl = 'browse_soft.php';
...
if(empty($activepath))$activepath=$cfg_soft_dir;
...
ShowMsg("成功上传文件！",$bkurl."?comeback=".urlencode($filename)."&f=$f&CKEditorFuncNum=$CKEditorFuncNum&dir=".urlencode($activepath)."&d=".time());
exit();