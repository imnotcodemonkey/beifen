...
class userLogin
{
    ...
    function keepUser()
    {
        if($this->userID != '' && $this->userType != '')
        {
            ...
            if (!isset($_SESSION[$this->keepUserIDTag]))//php 5.4及以上不再支持@session_register函数，故做此修改 2012年9月2日 20:07:46
...
//@session_register($this->keepAdminStyleTag);
    ...
    {
        ClearMyAddon();
		session_unset($this->keepUserIDTag);
		session_unset($this->keepUserTypeTag);
		session_unset($this->keepUserChannelTag);
		session_unset($this->keepUserNameTag);
		session_unset($this->keepUserPurviewTag);
        session_destroy();
