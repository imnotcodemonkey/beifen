...
class Archives
{
	...
	function ParAddTable()
	{
		...
		{
				$this->Fields['litpic'] = $GLOBALS['cfg_cmspath'].'/images/nopic.gif';
		}
		...
		$this->Fields['image'] = (!eregi('jpg|gif|png', $this->Fields['picname']) ? '' : "<img alt=\"\" src=\"{$this->Fields['picname']}\" />");
	...
	function ParseTempletsFirst()
	{
		...
		{
			$this->Fields['keywords'] = $this->Fields['title']; // ='';  2010.06.21 修改文章页调用关键词的时候读标题做关键词
		}
	...
	function GetPreNext($gtype='')
	{
		...
		if(count($this->PreNext)<2)
		{
			...
			else
			{
				...
				$this->PreNext['preimg'] ="<img src=\"/images/nophoto.jpg\" alt=\"对不起，没有上一图集了！\"/>";
			}
			if(is_array($nextRow))
			{
