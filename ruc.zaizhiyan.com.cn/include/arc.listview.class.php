...
class ListView
{
    ...
    function __construct($typeid, $uppage=1)
    {
        ...
        if(!$this->IsError)
        {
            ...
            if($this->Fields['seotitle']!=''){$this->Fields['title']=$this->Fields['seotitle'];}//leihaobin SEO 2011-11-25 17:35:35 //
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        {
			if($listitem=='paget')return '';//leihaobin 2011-11-25 17:16:50 用于列表页面
        ...
        if($listitem=='paget')$maininfo='';//leihaobin 2011-11-25 17:16:50 用于列表页面
        ...
        $pagedd="";//leihaobin SEO 列表页 2011-11-25 16:43:51
        for($j;$j<=$total_list;$j++)
        {
            if($j==$this->PageNo)
            {
                $listdd.= "<li class=\"thisclass\">$j</li>\r\n";
                if($this->PageNo !=1)$pagedd="_第".$j."页"; //leihaobin SEO 列表页 2011-11-25 16:43:51
            }
            else
            {
        ...
        if(preg_match('/paget/i',$listitem)) $plist = $pagedd; //leihaobin SEO 列表页 2011-11-25 16:43:51
