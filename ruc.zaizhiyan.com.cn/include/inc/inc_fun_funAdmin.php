...
function SpGetEditor($fname,$fvalue,$nheight="350",$etype="Basic",$gtype="print",$isfullpage="false",$bbcode=false)
{
    ...
    if(isset($_COOKIE['myeditor'])){$GLOBALS['cfg_html_editor']=$_COOKIE['myeditor'];}// leihaobin 2012-04-07 01:44:20 add select baidu ueditor
    if($gtype=="")
    {
        $gtype = "print";
    }
    ...
    else if($GLOBALS['cfg_html_editor']=='ckeditor')
    {
        ...
        $config = $events = array();
        $config['extraPlugins'] = 'dedepage,multipic,addon,checksave';// leihaobin 2011-12-07 01:44:20 add checksave
		if($bbcode)
		{
    ...
    {
        require_once(DEDEINC.'/bdueditor/ueditor.php');
        $UEditor = new UEditor();
        $UEditor->basePath = $GLOBALS['cfg_cmspath'].'/include/bdueditor/';
