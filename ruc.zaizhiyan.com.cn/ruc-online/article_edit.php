...
else if($dopost=='save')
{
    ...
    $ismake = $ishtml==0 ? -1 : 0;
    //$autokey = 1; leihaobin 取消强制自动获取关键词
    $title = htmlspecialchars(cn_substrR($title,$cfg_title_maxlen));
    $shorttitle = cn_substrR($shorttitle,160);
    $color =  cn_substrR($color,7);
    $writer =  cn_substrR($writer,20);
    $source = cn_substrR($source,30);
    $description = cn_substrR($description,$cfg_auot_description);//原来被强制改为了250，这里调用系统参数 leihaobin 2011-12-08 11:07:21
	...
	$msg.='<br /><iframe src="article_weibo.php?aid='.$id.'" width="660" height="600" scrolling="yes" allowtransparency="true" frameborder="0"></iframe>';
